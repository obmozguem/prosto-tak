...
import ru.oaosu.paksapr.organisation.dao.entity.*;
...
public class SearchOrganisationServiceTest {

    @Inject
    private SearchOrganisationService searchOrganisationService;
    ...
    void getOrganisation() {
        Organisation expectedOrganisation = createOrganisation();
        Organisation actualOrganisation = searchOrganisationService.getOrganisation(UUID.fromString("49068632-bef4-44a0-b30b-19155b52b402"));
        assertNotNull(actualOrganisation);
        assertEquals(expectedOrganisation.getOrganisationId(), actualOrganisation.getOrganisationId());
        ...
        compareEmployees(expectedOrganisation.getEmployees(), actualOrganisation.getEmployees());
    ...
    void compareBank(Bank expectedBank, Bank acrualBank) {
        assertEquals(expectedBank.getBankId(), acrualBank.getBankId());
